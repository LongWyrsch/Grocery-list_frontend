...
section Back end
    ...
    [Git] Write tests backend: done, wrtebr, after wrtefr, 1d
    %% ~ ~ ~ ~ ~ ~ ==> H E R E <== ~ ~ ~ ~ ~ ~ ~ 
...
section Front end 
    ...
    [Git] Translate Homepage cards: done, trhoca, after iipp, 1h 
    Secure app: done, seapfr, after iipp, 36h
    [Git] Update Process page with security section: done, uppss, after seapfr, 12h
    [Git] Write tests frontend: done, wrtefr, after uppss, 4d
    [Git] Update Process page to include Testing section: done, uppit, after wrtebr, 12h
